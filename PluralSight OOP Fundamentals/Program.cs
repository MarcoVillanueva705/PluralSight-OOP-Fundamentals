...
namespace PluralSight_OOP_Fundamentals
{
    class Program
    {
        ...
        //using the code within the class, must call the methods.  
        
        //Encapsulation is a key underlying principal that makes it possible to build large,
        //full-featured systems by breaking complex operations into encapsulated
        //units.  These encapsulated units are classes.  
        
        //Encapsulation allows the objects in an application to work together without each object knowing
        //the details of other object's implementation. Encapsulation hides both the
        //data and implementation within the class. 
